...
[![Clip](https://img.youtube.com/vi/oNC3363P_5s/hqdefault.jpg)](https://www.youtube.com/watch?v=oNC3363P_5s&t=166s)
<details>
<summary>Clip command</summary>

```bash
yt-dlp --download-sections "*2:46-3:45" "https://www.youtube.com/watch?v=oNC3363P_5s" --force-keyframes-at-cuts --merge-output-format mp4 -o "oNC3363P_5s-2m46s.mp4"
```
</details>
...
[![Clip](https://img.youtube.com/vi/oNC3363P_5s/hqdefault.jpg)](https://www.youtube.com/watch?v=oNC3363P_5s&t=78s)
<details>
<summary>Clip command</summary>

```bash
yt-dlp --download-sections "*1:18-2:10" "https://www.youtube.com/watch?v=oNC3363P_5s" --force-keyframes-at-cuts --merge-output-format mp4 -o "oNC3363P_5s-1m18s.mp4"
```
</details>
...
[![Clip](https://img.youtube.com/vi/oNC3363P_5s/hqdefault.jpg)](https://www.youtube.com/watch?v=oNC3363P_5s&t=461s)
<details>
<summary>Clip command</summary>

```bash
yt-dlp --download-sections "*7:41-8:40" "https://www.youtube.com/watch?v=oNC3363P_5s" --force-keyframes-at-cuts --merge-output-format mp4 -o "oNC3363P_5s-7m41s.mp4"
```
</details>
...
[![Clip](https://img.youtube.com/vi/oNC3363P_5s/hqdefault.jpg)](https://www.youtube.com/watch?v=oNC3363P_5s&t=485s)
<details>
<summary>Clip command</summary>

```bash
yt-dlp --download-sections "*8:05-9:00" "https://www.youtube.com/watch?v=oNC3363P_5s" --force-keyframes-at-cuts --merge-output-format mp4 -o "oNC3363P_5s-8m05s.mp4"
```
</details>
...
[![Clip](https://img.youtube.com/vi/oNC3363P_5s/hqdefault.jpg)](https://www.youtube.com/watch?v=oNC3363P_5s&t=588s)
<details>
<summary>Clip command</summary>

```bash
yt-dlp --download-sections "*9:48-10:40" "https://www.youtube.com/watch?v=oNC3363P_5s" --force-keyframes-at-cuts --merge-output-format mp4 -o "oNC3363P_5s-9m48s.mp4"
```
</details>
